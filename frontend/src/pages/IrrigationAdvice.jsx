      ...
      <div className="grid gap-8 lg:grid-cols-2">
         ...
         <div className="space-y-6">
            ...
            <button 
               ...
               disabled={loading}
               className={`w-full py-4 rounded-2xl font-semibold border-2 border-dashed transition-all flex items-center justify-center gap-2 ${showSchedule ? 'bg-blue-600 text-white border-blue-600 shadow-lg' : 'bg-blue-50 text-blue-700 border-blue-200 hover:bg-blue-100 disabled:opacity-50'}`}
            >
...
function SkeletonStatusCard() {
  return (
    <div className="rounded-3xl bg-white/5 border border-white/10 p-8 h-[320px] animate-pulse relative overflow-hidden">
      <div className="h-6 w-32 bg-white/10 rounded-full mb-6" />
      <div className="h-16 w-48 bg-white/20 rounded mb-4" />
      <div className="h-5 w-40 bg-white/10 rounded mb-12" />
...
function SkeletonWeatherCard() {
  return (
    <div className="bg-white/5 border border-white/10 rounded-[32px] p-8 h-[240px] animate-pulse">
      ...
      <div className="h-20 w-full bg-white/10 rounded-2xl mt-8" />
    </div>
  );
}
